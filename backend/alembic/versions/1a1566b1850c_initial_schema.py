...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_source_documents_filing_type",
        "source_documents",
        ["filing_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_chat_messages_thread_id_sequence_number",
        "chat_messages",
    ...
    op.create_index(
        "ix_message_citations_chunk_id", "message_citations", ["chunk_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_chat_messages_thread_id_sequence_number", table_name="chat_messages"
    )
